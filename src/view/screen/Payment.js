            ...
            <>
                <div className="payment">
                    ...
                    <div className="contact_details">
                        ...
                        <div>
                            <button onClick={Addtocart} style={{ width: 100, height: 40, margin: 10 }}>Add Address</button>
                            <button onClick={Addtocart} style={{ width: 100, height: 40, margin: 10 }} >Cancel</button>
                        </div>
                    </div>
                </div>
            </>
                    ...
                    <div>
                        <div className="change_address">
                            <div className="change_address1">
                                ...
                                <button onClick={addaddress} style={{ width: 200, height: 40, margin: 20, borderRadius: 10 ,position:"fixed",right:350}}>Address</button>
                            </div>
                        </div>
                        <div className="change_address2">
                            <p style={{marginLeft:30,fontSize:30,fontWeight:500}}>Payment : {data.rate} pay done</p>
                            <button onClick={paymentform} style={{ width: 200, height: 40, margin: 20, borderRadius: 10, position:"fixed",right:350 }}>Order Now</button>
                        </div>
                    </div>
